                ...
                <div className="w-3/5 flex flex-col justify-center pl-3 py-1">
                    <div>
                        <div className='flex flex-row justify-between'>
                            ...
                            {categoryTag && <p className="font-skillet flex font-[400] text-[#333333] text-[24px] leading-5 uppercase">
                                ₹ {Math.floor(productPrice)}
                            </p>
                            }
                        </div>
                        {categoryTag && <p className="font-skillet font-[400] text-[#333333] text-[24px] leading-5 uppercase">
                            {product.title}
                        </p>
                        }
