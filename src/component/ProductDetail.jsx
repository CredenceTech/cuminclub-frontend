        ...
        <>
            ...
            <section className="text-gray-600 body-font">
                    ...
                    <div className="lg:flex-grow md:w-1/2 px-3 lg:px-16  md:px-10 flex flex-col md:text-center items-center text-center">
                        ...
                        <div className="flex mb-3" >
                            {Array.from(
                                ...
                                (_, index) => (
                                    <img className='w-7' key={index} src={redChillyImage} alt="chilly" />
                                )
                            )}
                        </div>
                ...
                <div className='container mx-auto flex px-3 flex-col justify-center items-center'>
                    <h1 className="title-font sm:text-4xl text-3xl font-medium text-center text-[#53940F]">Recommended Sides</h1>
                    <p className="font-medium text-base lg:text-xl">Recommended Sides with {data?.title}</p>
