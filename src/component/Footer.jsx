...
export const Footer = () => {
  return (
    <div className="flex w-full flex-col lg:flex-row text-xs lg:text-base bg-[#B91C1B] text-white lg:justify-between justify-around items-center px-5 lg:px-48 relative top-20 h-20">
