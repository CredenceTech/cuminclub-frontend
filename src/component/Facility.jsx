    ...
    <div className='bg-white'>
      <div className='p-8'>
        <div class="w-full flex justify-between items-start">
          <div class="text-left">
            <h1 class="font-regola-pro text-[24px] font-normal leading-[28.8px] text-[#333333] mb-2">
              Know How we Operate
            </h1>
            <span class="font-regola-pro text-[36px] font-medium leading-[43.2px] text-[#333333]">
              All About Our Facilities!
            </span>
          </div>
          <button class="flex items-center justify-between h-[65px] rounded-[4px] bg-[#EADEC1] px-6">
            <span class="font-regola-pro text-[24px] font-normal leading-[28.8px] text-left text-[#333333]">
              Enquire for business
            </span>
            <svg xmlns="http://www.w3.org/2000/svg" width="19" height="14" viewBox="0 0 19 14" fill="none" class="ml-2">
        ...
        <div class="w-full text-left mt-4">
          <p class="font-regola-pro text-[24px] font-normal leading-[28.8px] text-[#757575]">
      ...
      <div className="p-8 flex">
        <div className="w-1/2 relative bg-cover bg-center mapBackgrounImage rounded-[14px] mr-2">
          <div className="absolute bottom-4 left-4 flex flex-col items-start">
            <p className="font-inter text-[36px] font-normal leading-[43.57px] text-[#333333]">
              Surat, Gujarat
            </p>
          </div>
          ...
          <div className="absolute bottom-4 right-4 flex items-center">
            <button className="flex items-center bg-[#94949491] rounded-[8px] px-4 py-2">
              <span className="text-[18px] font-regola-pro leading-[21.6px] text-[#FAFAFA]">
                Get Directions
              </span>
        ...
        <div className="w-1/2 flex flex-col pl-3">
          <h1 className="font-inter text-[32px] font-normal leading-[38.73px] text-[#333333] mb-4">
            We’re From the Heart of Gujarat!
          </h1>
          <p className="font-regola-pro text-[24px] font-normal leading-[28.8px] text-[#757575] mb-4">
            You can spot us right at <span className="font-regola-pro text-[24px] font-semibold leading-[28.8px] text-[#333333]">Gujarat Agro Mega Food Park</span> where we’re surrounded by fertile land and abundant resources.
            What does this mean? It means better, fresher ingredients in every meal. With quick access to major ports like Hazira, Nhava Sheva and JNPT, we make delivery faster, fresher and more reliable–no matter where you are.
          </p>
          <p className="font-regola-pro text-[24px] font-normal leading-[28.8px] text-[#757575]">
      ...
      <div className='p-8'>
        <div className="flex items-center mb-3">
          <p className="mr-2 font-regola-pro text-[36px] leading-[43.2px] font-semibold">We Bring Great Food to Life</p>
        ...
        <div className="relative flex items-center w-full overflow-hidden">
          <div className="slider-wrapper relative w-full overflow-hidden">
            ...
            >
              {sliderImageData.map((image, index) => (
                <div key={index} className="slider-slide flex-shrink-0 w-[80%] relative mr-40">
                  <img
                    src={image.image}
                    alt='sliding image'
                    className="w-full h-[500px] object-cover mr-20"
                  />
                  <div className="absolute bottom-4 left-4 font-skillet text-[36px] leading-[36.32px] text-[#FFFFFF] p-4 w-[70%]">
                    {image.text}
                  </div>
                </div>
              ))}
          ...
          <div
            className="absolute right-4 top-1/2 transform -translate-y-1/2 cursor-pointer z-20 w-[57px] h-[57px] bg-[#FFFFFF] flex items-center justify-center"
      ...
      <div className='pl-8 pt-8 pb-8 flex'>
        <div class="w-2/3 mr-6">
          <div class="flex flex-col text-left mb-8">
            <h1 class="text-[36px] font-medium leading-[43.2px] text-[#333333] font-regola-pro">
              Our Numbers Tell the Story
            </h1>
            <p class="text-[24px] font-normal leading-[28.8px] text-[#757575] font-regola-pro">
              In just 4 years, we’ve made an impact that speaks for itself
            </p>
          </div>
          <div class="flex space-x-8 mb-6">
            <div class="flex-1">
              <h2 class="text-[46px] font-semibold leading-[55.2px] text-[#333333] font-regola-pro">
                12.5 million KGs
              </h2>
              <p class="text-[24px] font-normal leading-[28.8px] text-[#757575] font-regola-pro">
        ...
        <div className='w-1/3 rounded-tl-[8px] rounded-bl-[8px] bg-[#D9D9D9]'>
      ...
      <div className='p-8'>
        <div className='w-full text-left'>
          <h1 className='text-[36px] font-medium leading-[43.2px] text-[#333333] font-regola-pro'>
            Peek Inside Our World-Class Facilities
          </h1>
          <p className='text-[24px] font-normal leading-[28.8px] text-[#757575] font-regola-pro mt-4'>
          ...
          <img src={facilityImg} alt="Facility" className='w-full mt-8 mb-8' />
          <p className='text-[24px] font-normal leading-[28.8px] text-[#757575] font-regola-pro mt-4'>
      ...
      <div className='p-8'>
        <h1 className='text-[36px] font-medium leading-[43.2px] text-[#333333] font-regola-pro text-left'>
          As Certified By:
        </h1>
        <div className='flex flex-wrap gap-[40px] mt-8 justify-center items-center'>
          {certifiedCompanyData.map((img, index) => (
            <div key={index} className='flex-shrink-0 w-[calc(25%-40px)] h-auto '>
              <img
                src={img}
                alt={`Image ${index + 1}`}
      ...
      <div className='p-8'>
        <h1 className='text-[36px] font-semibold leading-[43.2px] text-[#333333] font-regola-pro text-left'>
          Machineries We are Proud of →
        </h1>
        <div className='flex flex-wrap gap-[40px] mt-8'>
          {facilityAvailableData.map((item, index) => (
            <div key={index} className='flex-shrink-0 w-[calc(33%-40px)]'>
              <img
                src={item.image}
                alt={item.title}
                className='w-full h-auto object-cover'
              />
              <div className='mt-4'>
                <h2 className='text-[26px] font-medium leading-[31.2px] text-[#000000] font-regola-pro'>
                  {item.title}
                </h2>
                <p className='text-[16px] font-medium leading-[19.2px] text-[#757575] mt-2'>
                  {item.description}
                </p>
              </div>
            </div>
