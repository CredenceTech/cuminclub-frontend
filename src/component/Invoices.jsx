            ...
            <div className="container p-5 mx-auto">
              ...
              <div className="relative overflow-x-auto sm:rounded-lg">
                      ...
                      {orders.map((order, i) => (
                        <tr className="odd:bg-white even:bg-gray-50 border-b" key={i}>
                          ...
                          >
                            ...
                            <svg 
                              className="absolute right-[70px] top-[55%] transform -translate-y-1/2 opacity-0 group-hover:opacity-100 transition-opacity duration-200" 
                              width="14" 
                              height="10" 
                              viewBox="0 0 14 10" 
                              fill="none" 
                ...
                <div className="sm:hidden"> {/* Cards for mobile screens */}
                  {orders.map((order, i) => (
                    <div className="bg-white shadow-lg rounded-lg p-4 mb-4" key={i}>
