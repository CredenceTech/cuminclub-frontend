                    ...
                    <div id="cart-modal">
                        <div className="relative  bg-[#EFE9DA] md:w-[70%] lg:w-[50%] xl:w-[40%] w-[90%] h-[100vh]" style={{
                            ...
                            >
                                ...
                                {(!cartResponse || cartResponse === null || cartResponse.cart?.lines?.edges?.length === 0) && <div className="flex flex-col items-center justify-center py-10 text-center font-regola-pro md:text-xl text-lg space-y-4 mt-[150px]">
                                ...
                                {cartResponse && cartResponse.cart?.lines?.edges?.length > 0 && <div className="p-[20px] md:p-[40px] pt-5">
                                    {cartResponse?.cart?.lines?.edges?.map((line, index) => {
                                        return <div key={index} className="border-b-[0.99px] border-[#A3A3A3]">
                                            ...
                                            <div className='md:ml-[91px] ml-[81px]'>
