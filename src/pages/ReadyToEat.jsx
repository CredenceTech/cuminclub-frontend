                          ...
                          <AnimatePresence mode="popLayout">
                            ...
                            >
                              <div className="relative flex justify-center items-center">
                                ...
                                <button
                                  type="button"
                                  className="bg-[#FBAE36] text-[20.36px] leading-[27.08px] absolute top-5 left-5 text-[#333333] px-3 rounded-[10px] pt-2 pb-[8px] tracking-[0.12em] font-regola-pro uppercase font-[600]"
                                >
                                  {categoryTag}
                                </button>
                              </div>
                            ...
                            >
                              ...
                              <div className="absolute top-0 left-0 w-full flex flex-col justify-between h-full">
                                <div className="p-5">
                                  <button
                                    type="button"
                                    className="bg-[#279C66] text-[#FAFAFA] text-[20.36px] uppercase leading-[27.08px] px-3 tracking-[0.12em] rounded-[10px] pt-2 pb-[8px] font-regola-pro font-[800]"
                                  >
                                    {categoryTag}
                                  </button>
                                </div>
