      ...
      {apiResponse ? (
        <div className="min-h-[75vh] w-full bg-[#EFE9DA]">
          ...
          <>
            ...
            <div
              className="container mx-auto p-[60px]"
            // style={{
            //   height: "62vh",
            // }}
            >
                                    ...
                                    <div className='col-span-2 bg-[#EADEC1] rounded-3xl' key={item?.id}>
                                        <AnimatePresence mode="popLayout">
                                            ...
                                            >
                                                <div className="relative">
                                                    <img src={item?.image} alt="product" className="w-full h-[300px] rounded-t-3xl" />
                                                    <button type="button" className="bg-[#FBAE36] text-[20.36px] leading-[27.08px] absolute top-5 left-5 text-[#333333] px-3 rounded-[10px] py-2 tracking-[0.12em] font-regola-pro font-[800]">LENTIL</button>
                                                </div>
                                                <div className=" px-10 py-5">
                                        ...
                                        <AnimatePresence mode="wait">
                                            ...
                                            >
                                                ...
                                                <div className="absolute top-0 left-0 w-full flex flex-col justify-between h-full">
                                                    <div className="p-5">
                                                        <button type="button" className="bg-[#279C66] text-[#FAFAFA] text-[20.36px] leading-[27.08px] px-3 tracking-[0.12em] rounded-[10px] py-2 font-regola-pro font-[800]">CURRY</button>
                                                    </div>
