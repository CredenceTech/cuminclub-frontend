...
import rtcTitleImg from '../assets/rtc-title-img.png'
        ...
        <div className="w-full bg-[#EFE9DA] relative -top-[100px]">
            <div className="grid grid-cols-2 lg:grid-cols-3" >
                <div className="col-span-2 order-last lg:order-first">
                    <div className="h-[100px] hidden lg:flex lg:h-[357px] bg-[#0F0B05] xl:flex justify-center items-center"><img src={rtcTitleImg} className=" xl:mt-[80px] xl:ml-[50px] xl:mr-[60px]" /></div>
