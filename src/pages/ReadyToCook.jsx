                                                            ...
                                                            <AnimatePresence mode="popLayout">
                                                                ...
                                                                >
                                                                    <div className="relative">
                                                                        <img src={product?.metafields?.find((mf) => mf?.key === 'product_large_card_image')?.reference?.image?.originalSrc} alt="product" className="w-full h-[300px] rounded-t-3xl object-cover" />
                                                                        <button type="button" className="bg-[#FBAE36] text-[20.36px] leading-[27.08px] absolute top-5 left-5 text-[#333333] px-3 rounded-[10px] pt-2 pb-[8px] tracking-[0.12em] font-regola-pro font-[800]">{product.superTitle}</button>
                                                                    </div>
                                                                    <div className=" px-10 py-5">
                                                                        <div className="flex flex-row justify-between pt-[18px] pb-2">
                                                                            <p className="font-regola-pro font-[800] uppercase text-[#333333] text-[30px] leading-[23.88px]">{product.title}</p>
                                                                            <p className="font-regola-pro font-[800] text-[#333333] text-[30px] leading-[23.88px]">₹ {product.priceRange.minVariantPrice.amount}</p>
                                                                        </div>
                                                                        <p className="text-[20px] leading-[15.92px] font-[500] font-regola-pro text-[#757575] pt-2 pb-3">{product.description.length > 80
                                                                            ? `${product.description.substring(0, 80)}...`
                                                                            : product.description}</p>
                                                                        <div className="flex gap-x-4 mt-1">
                                                                            <button type="button" className="border-2 border-[#333333] text-[#333333] px-3 rounded-lg py-[4px] font-regola-pro  text-[16px] font-[800] leading-[21.28px] tracking-[0.12em]" onClick={(e) => {
                                                                                e.stopPropagation();
                                                                                handleAddToCart(product.variants.edges[0].node.id)
                                                                            }
                                                                            }>ADD TO CART</button>
                                                                            <button type="button" className="bg-[#26965C] text-[#FAFAFA] px-3 rounded-lg py-[4px] font-regola-pro  text-[16px] font-[800] leading-[21.28px] tracking-[0.12em]" onClick={(e) => e.stopPropagation()}>BUY NOW</button>
                                                                        </div>
                                                                    </div>
                                                                </motion.div>
                                                            </AnimatePresence>
