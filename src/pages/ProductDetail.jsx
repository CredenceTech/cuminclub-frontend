...
function ProductDetail() {
    ...
    return (
        <div className='bg-white'>
                ...
                <div className="lg:flex-grow md:w-1/2 mt-14 lg:mr-20 2xl:mr-40 w-full mb-10 md:mb-0">
                    ...
                    <div className='px-4 md:px-0'>
                        ...
                        <div className='flex items-center'>
                            <button type='button' className='text-base px-4 py-[6px] bg-[#FBAE36] rounded-lg text-[#333333]'>DIY COOKING KIT</button>
                            <div className="flex ml-4">
                                <Rating rating={4} text={"200 Reviews"} />
                            </div>
                        </div>
                        <p className='text-base mt-3 pl-2 text-[#757575]'>{`₹ ${'250' || 0}`}</p>

                        <div className="flex justify-center items-center relative">
                        </div>
                        <p className="text-base mt-3 pl-2 text-[#757575]">
                            {data?.description}
                        </p>
                        ...
                        <div className='flex pl-2 flex-row gap-x-5'>
                            <button className='px-8 py-2 bg-[#EDEDED] font-semibold rounded text-base text-[#EB7E01]' type='button'>Add to Cart</button>
                            <button className='px-8 py-2 bg-[#FEB14E] font-semibold rounded text-base text-[#FFFFFF]' type='button'>Subscribe</button>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div className="col-span-6 md:col-span-5 pl-4 pt-4">
                        <div className="w-full mb-4  flex lg:mb-0">
                            <div className="w-full flex gap-x-7">
                                ...
                                >
                                    <div className="w-[230%] h-[400px] relative -left-[10%] overflow-hidden">
                                        <img
                        ...
                        <div className='flex justify-between items-center pb-10'>
                            <div className="flex">
                                <h3 className="text-5xl p-3 font-bold opacity-50 text-[#FFFFFF] mb-4">1</h3>
                                <p className="text-lg w-4/6 pt-3 text-[#FFFFFF]">
            ...
            <div><p className='px-5 md:px-[180px] text-3xl font-skillet'>You May Also Like</p></div>
            <div className='2xl:container 2xl:mx-auto flex justify-center items-center py-14 ml-[10px]'>
                <div className='flex flex-row justify-around px-7 md:px-4 md:justify-start md:mx-5 lg:mx-10 flex-wrap gap-x-8 gap-y-4'>
                    {apiResponse?.map((item, i) => (
                        <div key={i} className='flex flex-col justify-between lg:justify-start'>
                            ...
                            >
                                <div>
                                    <p className='text-[#231F20] text-base font-medium md:text-lg '>
                                        {item?.node?.title}
                                    </p>
